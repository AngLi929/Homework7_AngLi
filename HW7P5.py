...
class CalibratedModel:
    ...
    def __init__(self, cvs_file_name):
        ...
        self._cohortIDs = cols[CalibrationColIndex.ID].astype(int)
        self._weights = cols[CalibrationColIndex.W]
        self._mortalityProbs = cols[CalibrationColIndex.MORT_PROB]
    ...
    def simulate(self, num_of_simulated_cohorts, cohort_size, time_steps, cohort_ids=None):
        ...
        self._multiCohorts.simulate(1000)
